 ...
 * @method \Intervention\Image\Image edge(integer $amount = 1)                                                                                                            Apply an edge blur filter with a optional amount on the current image. Use values between 0 and 100.
