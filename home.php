...
require "vendor/GifCreator/GifCreator.php";
?>
    ...
    <div class="cd-slider-nav">
        <nav class="navbar">
            <div class="tm-navbar-bg">
                <a class="navbar-brand text-uppercase" href="#"><i class="fa fa-picture-o tm-brand-icon"></i>Galeries</a>
                <div id="tmNavbar">
                            ...
                            try {
                                ...
                                if ($prepare->execute()) {
                                    ...
                                    while ($user = $prepare->fetch(PDO::FETCH_OBJ)) {
                                        $login = $user->login;
                                        $prepare2 = $connection->prepare('select * from images where userId = :userId');
...
if (isset($_SESSION['user']))
{
    echo "    <form class=\"form-control\" method=\"post\">
        <button type=\"submit\" name=\"close\">Se déconnecter</button>
    </form>";
}